...
export default function AddMoney() {
  ...
  const handleAddMoney = async () => {
    ...
    setIsLoading(true);
    try {
      // Here you would make the API call to add money
      ...
      alert(
        `Successfully added ${selectedCard.symbol}${amount} to your ${selectedCard.currency} wallet!`
      );
      setAmount("");
    } catch (error) {
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {["50", "100", "500"].map((quickAmount) => (
                    <button
                      ...
                      className="py-2 px-4 border border-gray-300 rounded-md text-sm text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all"
                    >
                      {selectedCard?.symbol || "$"}
                      {quickAmount}
                    </button>
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-3 py-4 bg-black hover:bg-zinc-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-xl transition-all font-semibold"
              >
                {isLoading ? (
                  <>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-gray-900">
                  {paymentMethod === "bank" ? "1-2 business days" : "Instant"}
                </span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-gray-900">Live market rate</span>
              </div>
            </div>
          </div>
        </div>
